...
urlpatterns = [
    ...
    # JSON API
    url(r'^api/$', views.api_base, name='yarr-api_base'),
    url(r'^api/feed/get/$', views.api_feed_get, name='yarr-api_feed_get'),
    url(r'^api/feed/pks/$', views.api_feed_pks_get, name='yarr-api_feed_pks_get'),
    url(r'^api/entry/get/$', views.api_entry_get, name='yarr-api_entry_get'),
    url(r'^api/entry/set/$', views.api_entry_set, name='yarr-api_entry_set'),
]
